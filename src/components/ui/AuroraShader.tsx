...
export default memo(function AuroraShader({
  ...
  // Refs para valores que mudam sem precisar recriar o WebGL
  ...
  useEffect(() => {
    ...
    // Não adiciona mousemove em mobile (touch devices) para economizar CPU
  ...
  }, []); // Só inicializa uma vez — amplitude/blend/speed lidos via refs no loop

  return (
    <div
      ref={containerRef}
      className={`w-full h-full absolute bottom-0 ${className}`}
